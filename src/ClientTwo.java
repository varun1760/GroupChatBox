...
public class ClientTwo extends JFrame implements Runnable{  // runnable to make multiple threads
    ...
    ClientTwo(){
        ...
        setLocation(450, 50);   // location of chat window in screen
...
// TODO : Scrolling TextFiled needed
        ...
        send.addActionListener(e -> {
            String message = "THOR: " + text.getText();  // getting message that user typed as string.
