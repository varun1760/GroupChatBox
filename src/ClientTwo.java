...
public class ClientTwo extends JFrame implements Runnable{  // runnable to make multiple threads
    ...
    ClientTwo(){
        ...
        setLocation(450,100);   // location of chat window in screen
...
/*  NOTE:
    ...
    */
        ...
        addMyIcon("icons/hulk.png",60,60);
        label.setBounds(40,0,60,60);
        panel.add(label);

        // building display Name label
        JLabel label_name = new JLabel("HULK");
...
// TODO : Scrolling TextFiled needed
        ...
        send.addActionListener(e -> {
            String message = "BANNER: "+text.getText();  // getting message that user typed as string.
...
//       add into panel and when next message will arrive it will printed into next line
    ...
    public static void main(String[] args) {
        ...
        clientTwo.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        clientTwo.setVisible(true);

        // calling thread class explicitly
        Thread thread = new Thread(clientTwo);  // passing constructor object to create thread(s)
