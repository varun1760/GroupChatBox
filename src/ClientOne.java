...
public class ClientOne extends JFrame implements Runnable{  // runnable to make multiple threads
    ...
    ClientOne(){
        ...
        setLocation(50,100);   // location of chat window in screen
...
// TODO: scrolling textField needed
        ...
        send.addActionListener(e -> {
            String message = "STARK: "+text.getText();  // getting message that user typed as string.
...
//       add into panel and when next message will arrive it will printed into next line
    ...
    public static void main(String[] args) {
        ...
        clientOne.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        clientOne.setVisible(true);

        // calling thread class explicitly
        Thread thread = new Thread(clientOne);  // passing constructor object to create thread(s)
