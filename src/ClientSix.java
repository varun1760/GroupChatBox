...
public class ClientSix extends JFrame implements Runnable{
    JPanel panel;
    JLabel label;
    JButton send;
    JTextField text;
    ...
    ClientSix(){
        ...
        setLocation(900,200);   // location of chat window in screen
...
/*  NOTE:
    ...
    */
        ...
        addMyIcon("icons/superman.png",60,60);
        label.setBounds(40,0,60,60);
        panel.add(label);

        // building display Name label
        JLabel label_name = new JLabel("SuperMan");
...
// TODO : Scrolling TextField needed
    ...
    public static void main(String[] args) {
        ...
        Thread thread = new Thread(clientsix);
        thread.start();
    }
}
