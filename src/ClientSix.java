...
public class ClientSix extends JFrame implements Runnable{  // runnable to make multiple threads
    ...
    ClientSix(){
        ...
        setLocation(900, 150);   // location of chat window in screen
...
/*  NOTE:
    ...
    */
        ...
        // building Name label
        JLabel name = new JLabel("B.WIDOW");
...
// TODO : Scrolling TextFiled needed
        ...
        send.addActionListener(e -> {
            String message = "NATASHA: " + text.getText();  // getting message that user typed as string.
...
//       add into panel and when next message will arrive it will printed into next line
    ...
    public static void main(String[] args) {
        ClientSix clientSix = new ClientSix();
        clientSix.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        clientSix.setVisible(true);

        // calling thread class explicitly
        Thread thread = new Thread(clientSix);  // passing constructor object to create thread(s)
