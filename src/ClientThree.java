...
public class ClientThree extends JFrame implements Runnable{  // runnable to make multiple threads
    ...
    ClientThree(){
        ...
        setLocation(850,100);   // location of chat window in screen
...
/*  NOTE:
    ...
    */
        ...
        addMyIcon("icons/spider-man.png",60,60);
        label.setBounds(40,0,60,60);
        panel.add(label);

        // building display Name label
        JLabel label_name = new JLabel("SpiderMan");
...
// TODO : Scrolling TextField needed
        ...
        send.addActionListener(e -> {
            String message = "PARKER: "+text.getText();  // getting message that user typed as string.
...
//       add into panel and when next message will arrive it will printed into next line
    ...
    @Override
    public void run() {
        // printing message into chatArea
        try{
    ...
    public static void main(String[] args) {
        ...
        clientThree.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        clientThree.setVisible(true);

        // calling thread class explicitly
        Thread thread = new Thread(clientThree);  // passing constructor object to create thread(s)
