...
public class ClientSeven extends JFrame implements Runnable{  // runnable to make multiple threads
    ...
    ClientSeven(){
        ...
        setLocation(200, 250);   // location of chat window in screen
...
/*  NOTE:
    ...
    */
        ...
        // building Name label
        JLabel name = new JLabel("DrSTRANGE");
...
// TODO : Scrolling TextFiled needed
        ...
        send.addActionListener(e -> {
            String message = "DrSTRANGE: " + text.getText();  // getting message that user typed as string.
...
//       add into panel and when next message will arrive it will printed into next line
    ...
    public static void main(String[] args) {
        ClientSeven clientSeven = new ClientSeven();
        clientSeven.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        clientSeven.setVisible(true);

        // calling thread class explicitly
        Thread thread = new Thread(clientSeven);  // passing constructor object to create thread(s)
