...
public class ClientEight extends JFrame implements Runnable{  // runnable to make multiple threads
    ...
    ClientEight(){
        ...
        setLocation(600, 250);   // location of chat window in screen
...
/*  NOTE:
    ...
    */
        ...
        // building Name label
        JLabel name = new JLabel("C.MARVEL");
...
// TODO : Scrolling TextFiled needed
        ...
        send.addActionListener(e -> {
            String message = "DENVERS: " + text.getText();  // getting message that user typed as string.
...
//       add into panel and when next message will arrive it will printed into next line
    ...
    public static void main(String[] args) {
        ClientEight clientEight = new ClientEight();
        clientEight.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        clientEight.setVisible(true);

        // calling thread class explicitly
        Thread thread = new Thread(clientEight);  // passing constructor object to create thread(s)
