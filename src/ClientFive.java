...
public class ClientFive extends JFrame implements Runnable{  // runnable to make multiple threads
    ...
    ClientFive(){
        ...
        setLocation(500, 150);   // location of chat window in screen
...
/*  NOTE:
    ...
    */
        ...
        // building Name label
        JLabel name = new JLabel("SPIDERMAN");
...
// TODO : Scrolling TextFiled needed
        ...
        send.addActionListener(e -> {
            String message = "PETER: " + text.getText();  // getting message that user typed as string.
...
//       add into panel and when next message will arrive it will printed into next line
    ...
    public static void main(String[] args) {
        ...
        Thread thread = new Thread(clientFive);  // passing constructor object to create thread(s)
